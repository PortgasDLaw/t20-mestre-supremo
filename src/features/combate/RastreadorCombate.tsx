  ...
  return (
    <div className="space-y-4">
      ...
      {combatentes.length === 0 ? (
        <EmptyState
          icon={Shield}
          message="Nenhum combatente ainda"
          hint="Adicione jogadores e monstros para começar"
          action={{ label: 'Adicionar Combatente', icon: <Plus className="w-4 h-4" />, onClick: () => setModalAberto(true) }}
        />
      ) : (
